...
<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?clientId=D3AilmkKicXrxUyEPdNd&submodules=geocoder"></script>
<title>새 글 쓰기</title>
...
<hr color="red">
	<form:form commandName="boardVO" method="post"  enctype="multipart/form-data">
		<table align="center" border="1" width="1000">
			<tr>
				<td width="70" height="250" rowspan="6">
			
    <img id="preview" src="" width="240" height="250" alt="썸네일"/>
				</td>
				<th width="50"><form:label path="title">제목</form:label></th>
				<td><form:input path="title"/>
					<form:errors path="title"/></td>
					<td width="400" rowspan="7"><div id="map" style="width:100%;height:300px;"></div></td>
			</tr>
			...
			<tr>
			<tr>
					<td><input  width="300" type="file"  name="uploadfile" id="uploadfile" accept="image/*"/></td>
			...
			<td></td>
				...
				<tr>
				<td colspan="3" ><form:textarea id="ir1" path="content" rows="10" cols="100" style="width:600px; height:412px; "/>
					<form:errors path="content"/></td>
					<td>
							</div>
		<div align="center">
		  Upload Directory : <input type="text" name="upDir" value="C:/Users/DK/Desktop/multi/"/><br><br>
       ...
       <!--  <a href="#this" class="btn" id="write">작성하기</a>
		...
		<div  style="width:400px; height:400px; overflow:auto ;margin-left: auto;margin-right:auto;">
